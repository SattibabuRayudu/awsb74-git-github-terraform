...
variable "public_subnet_cidrs" {
  type    = list(any)
  default = ["10.125.1.0/24", "10.125.2.0/24", "10.125.3.0/24", "10.125.4.0/24", "10.125.5.0/24"]
  #                  0              1               2
}

variable "private_subnet_cidrs" {
  type    = list(any)
  default = ["10.125.10.0/24", "10.125.20.0/24", "10.125.30.0/24", "10.125.40.0/24", "10.125.50.0/24"]
  #                  0              1               2
}
